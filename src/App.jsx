                                ...
                                <div className="flex items-center gap-1">
                                  ...
                                  {cryptoWithLivePrice.isLive && (
                                    <>
                                      ...
                                      <span className="hidden sm:flex text-xs bg-green-500/20 text-green-400 white-black:bg-white/10 white-black:text-white px-1.5 py-0.5 rounded items-center gap-1 flex-shrink-0 live-badge">
                                        <span className="inline-block w-1 h-1 bg-green-400 white-black:bg-white rounded-full animate-pulse live-dot"></span>
                                        {t.live}
                                      </span>
                                    </>
                                  )}
