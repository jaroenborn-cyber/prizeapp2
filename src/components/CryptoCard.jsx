  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-2 sm:mb-4">
        ...
        <div className="grid grid-cols-2 gap-1 sm:flex sm:items-center sm:gap-2">
          <div className="flex items-center gap-1">
            ...
            <span 
              className="text-xs bg-slate-700 dark:bg-slate-700 light:bg-slate-200 high-contrast:bg-gray-300 text-white dark:text-white light:text-slate-800 high-contrast:text-black px-1.5 py-0.5 sm:px-2 sm:py-1 rounded"
